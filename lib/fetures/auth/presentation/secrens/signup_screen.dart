...
import 'package:bluebits_app/fetures/auth/presentation/secrens/signin_screen.dart';
...
import 'package:bluebits_app/fetures/home.dart';
                        ...
                        children: [
                          ...
                          BlocConsumer<AuthcubitCubit, AuthcubitState>(
                            ...
                            builder: (context, state) {
                              return CustomButton(
                                text: state is AuthcubitLoading
                                    ? 'جاري الإرسال...'
                                    : 'إنشاء الحساب',
                                onPressed: () {
